...
from xformers.ops.common import List
...
from .shared_attn import Attention as SharedAttention
    ...
    def __init__(self, args: BaseTransformerArgs):
        ...
        if args.attn_sharing:
            self.attention = SharedAttention(
                ...
                qkv_sharing=args.qkv_sharing,
                head_sharing=args.head_sharing,
