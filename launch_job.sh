...
#SBATCH --output=/home/sanaelotfi/layer_sharing/colm_logs/%x_%j.out
#SBATCH --error=/home/sanaelotfi/layer_sharing/colm_logs/%x_%j.err
# Usage: sbatch launch_job.sh path/to/config.yaml

PROJECT_DIR="/home/sanaelotfi/layer_sharing"
