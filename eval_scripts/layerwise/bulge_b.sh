...
# Run: bulge_b (wandb ID: ezv1w9xp)
# Project: weight-sharing/layerwise
# Dump dir: /checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/LAYERWISE_v3/bulge_b
...
DUMP_DIR="/checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/LAYERWISE_v3/bulge_b"
