...
# Run: 250M_cyclerev (wandb ID: ym7sztwu)
# Project: weight-sharing/layerwise
# Dump dir: /checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/LAYERWISE_v3/250M/250M_cyclerev
...
DUMP_DIR="/checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/LAYERWISE_v3/250M/250M_cyclerev"
