...
# Run: cycle_b (wandb ID: q5pi3xyy)
# Project: weight-sharing/layerwise
# Dump dir: /checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/LAYERWISE_v3/cycle_b
...
DUMP_DIR="/checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/LAYERWISE_v3/cycle_b"
