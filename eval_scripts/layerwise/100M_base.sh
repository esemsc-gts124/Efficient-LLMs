...
# Run: 100M_base (wandb ID: lc67tuu6)
# Project: weight-sharing/layerwise
# Dump dir: /checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/LAYERWISE_v3/100M_base
...
DUMP_DIR="/checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/LAYERWISE_v3/100M_base"
