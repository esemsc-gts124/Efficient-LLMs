...
# Usage: sbatch eval_scripts/slurm_colm_emb_rank.sh eval_scripts/colm-emb-rank/<run_name>.sh
...
export OUTPUT_PATH="/checkpoint/optim/sanaelotfi/weight_shared_llms/eval_results/colm/emb_rank"
...
if [ -z "$RUN_SCRIPT" ]; then
    echo "Error: pass a run script, e.g.: sbatch eval_scripts/slurm_colm_layerwise.sh eval_scripts/colm-emb-rank/250M_bulge.sh"
    exit 1
fi
