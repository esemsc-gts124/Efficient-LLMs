...
# Run: Shared_945m (wandb ID: 8rbbokn2)
# Project: weight-sharing/icml-experiments
# Dump dir: /checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/attn_sharing/1b_exps/945m_shared
...
DUMP_DIR="/checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/attn_sharing/1b_exps/945m_shared"
