...
# Run: Baseline_220m (wandb ID: uwcgabyi)
# Project: weight-sharing/icml-experiments
# Dump dir: /checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/attn_sharing/250m_exps/220m_baseline.yaml
...
DUMP_DIR="/checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/attn_sharing/250m_exps/220m_baseline.yaml"
