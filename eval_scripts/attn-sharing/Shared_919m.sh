...
# Run: Shared_919m (wandb ID: 9pc9p8ka)
# Project: weight-sharing/icml-experiments
# Dump dir: /checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/attn_sharing/1b_exps/919m_shared
...
DUMP_DIR="/checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/attn_sharing/1b_exps/919m_shared"
