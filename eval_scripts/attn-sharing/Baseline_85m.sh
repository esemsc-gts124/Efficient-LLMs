...
# Run: Baseline_85m (wandb ID: 6x6bf2e9)
# Project: weight-sharing/icml-experiments
# Dump dir: /checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/attn_sharing/100m_exps/85m_baseline
...
DUMP_DIR="/checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/attn_sharing/100m_exps/85m_baseline"
