...
# Run: Baseline_1b (wandb ID: e6oksexj)
# Project: weight-sharing/icml-experiments
# Dump dir: /checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/attn_sharing/1b_exps/1b_baseline
...
DUMP_DIR="/checkpoint/optim/sanaelotfi/weight_shared_llms/checkpoints/final_runs/attn_sharing/1b_exps/1b_baseline"
