...
# Usage: sbatch eval_scripts/slurm_colm.sh eval_scripts/colm/<run_name>.sh
...
export REPO_PATH="$HOME/attn_sharing"
export OUTPUT_PATH="/checkpoint/optim/sanaelotfi/weight_shared_llms/eval_results/colm/attn_sharing"
...
if [ -z "$RUN_SCRIPT" ]; then
    echo "Error: pass a run script, e.g.: sbatch eval_scripts/slurm_colm.sh eval_scripts/colm/Baseline_250m.sh"
    exit 1
fi
